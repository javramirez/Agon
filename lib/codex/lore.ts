...
export const LORE_MENTORES: EntradaLore[] = [
  {
    ...
    lore: `Leónidas de Esparta no era solo un rey. Era el producto de un sistema de educación militar — la agoge — diseñado para producir el guerrero perfecto desde la infancia. Su decisión en las Termópilas no fue heroísmo espontáneo; fue la consecuencia lógica de décadas de preparación para exactamente ese momento.
...
Diógenes como Mentor no valida excusas. Las destruye. No con crueldad — con la precisión de alguien que ha pensado más profundamente que tú sobre la naturaleza del compromiso, la disciplina y la autoengaño. Sus respuestas son breves. Sus preguntas son devastadoras.
