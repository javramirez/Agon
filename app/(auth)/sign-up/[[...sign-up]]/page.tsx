  ...
  return (
    <>
      <style>{`
        ...
        .cl-identityPreviewText { color: #f5f5f5 !important; }
        .cl-identityPreviewEditButton { color: #F59E0B !important; }
        .cl-formFieldInputShowPasswordButton { color: #888 !important; }
        .cl-formFieldInputShowPasswordButton:hover { color: #f5f5f5 !important; }
        ...
        .cl-logoImage, .cl-logoBox { display: none !important; }
      `}</style>
      ...
      <div className="min-h-screen bg-[#080808] text-foreground flex flex-col overflow-hidden">
        ...
        <div className="relative z-10 flex-1 flex flex-col lg:flex-row items-center justify-center gap-16 px-6 py-12 max-w-5xl mx-auto w-full min-h-0">
          <div className="flex-1 text-center lg:text-left space-y-8 max-w-sm">
            <div className="space-y-3">
              ...
              <h1 className="font-display text-4xl sm:text-5xl font-bold leading-tight">
                Forja tu
                <br />
                <span className="text-amber">legado.</span>
              </h1>
            </div>

            <p className="text-muted-foreground font-body text-sm leading-relaxed">
              El Gran Agon comienza con un nombre inscrito en el Altis. Elige tu camino — solo o en
              duelo — y que los siete dioses del Olimpo sean testigos de cada hábito completado o
              abandonado.
            </p>
            ...
            <blockquote className="border-l-2 border-amber/30 pl-4 text-left">
              <p className="text-sm text-muted-foreground font-body italic leading-relaxed">
                &ldquo;En el agon griego, nadie llegaba al Altis por accidente. Cada nombre inscrito
                fue ganado con sudor, constancia y voluntad de no rendirse cuando el cuerpo pedía
                descanso.&rdquo;
              </p>
            </blockquote>
            ...
            <div className="hidden lg:flex flex-col gap-2">
              ...
              <div className="flex gap-3">
                <div className="flex items-center gap-2 bg-surface-1 border border-border rounded-xl px-3 py-2">
                  ...
                  <span className="text-xs font-display font-bold text-amber">Solo</span>
                </div>
                <div className="flex items-center gap-2 bg-surface-1 border border-border rounded-xl px-3 py-2">
                  <span className="text-sm">⚔️</span>
                  <span className="text-xs font-display font-bold" style={{ color: '#C41E1E' }}>
                    Duelo
                  </span>
                </div>
              </div>
              <p className="text-xs text-muted-foreground/40 font-body">
                Elegirás después de registrarte
              </p>
            </div>
          </div>
          ...
          <div className="relative flex-shrink-0">
            ...
            >
              ...
              <div className="pt-6 pb-2 px-6 text-center space-y-1">
                ...
                <p className="text-xs text-muted-foreground font-body">
                  Crea tu cuenta para comenzar el desafío
                </p>
              </div>
              ...
              >
                <SignUp appearance={SIGN_UP_APPEARANCE} fallbackRedirectUrl="/seleccionar-modo" />
              </Suspense>
            ...
            <p className="text-center text-xs text-muted-foreground/50 font-body mt-4">
              ¿Ya tienes cuenta?{' '}
              <Link href="/sign-in" className="text-amber hover:text-amber/80 transition-colors">
                Entrar al Agon
              </Link>
            </p>
          </div>
        ...
        <div className="relative z-10 px-6 py-5 text-center border-t border-white/5">
          <p className="text-xs text-muted-foreground/30 font-body tracking-widest uppercase">
            Agon · 29 días · Solo o en Duelo · El Altis inscribe todo
          </p>
        </div>
      </div>
    </>
